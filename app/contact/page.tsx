						...
						<Card>
							<Link
								...
								<div className="z-10 flex flex-col items-center">
									<span className="text-ellipsis lg:text-xl font-medium duration-150 xl:text-3xl text-zinc-200 group-hover:text-white font-display ">
										{s.handle}
									</span>
