...
```sh-session
git clone https://github.com/ahmadsalahuddeen/chronark.com.git
cd chronark.com
```


Create a `.env` file similar to [`.env.example`](https://github.com/ahmadsalahuddeen/chronark.com/blob/main/.env.example).
